                        ...
                        <v-simple-table dense>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <v-text-field maxlength="2" flat dense color="orange" style="font-size:18px; font-weight: bold; width: 30px;" type="text" v-model="nuevosector" :placeholder="sector" />
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="mb-0" style="font-size:18px; font-weight: bold;">Módulo</p></td>
                                    <td>
                                        <v-text-field maxlength="2" flat dense color="orange" style="font-size:18px; font-weight: bold;width: 30px;" type="text" v-model="nuevomodulo" :placeholder="modulo" />
                                    </td>
                                </tr>
                            </tbody>
                        </v-simple-table>
                        ...
                        <v-simple-table dense>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <v-text-field maxlength="2" flat dense color="orange" style="font-size:18px; font-weight: bold;width: 30px;" type="text" v-model="nuevoestante" :placeholder="estante" />
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="mb-0" style="font-size:18px; font-weight: bold;">Posición</p></td>
                                    <td>
                                        <v-text-field maxlength="2" flat dense color="orange" style="font-size:18px; font-weight: bold;width: 30px;" type="text" v-model="nuevapos" :placeholder="posicion" />
                                    </td>
                                </tr>
                            </tbody>
                        </v-simple-table>
